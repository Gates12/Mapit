...
function initMap() {
  ...
  // ---------- marker box
  var markerButton = document.getElementById("button-3");
  ...
  const firebaseConfig = {
    apiKey: "AIzaSyALzMNtyBz54i9spjARtYSKW8aB6YAWoT4",
    authDomain: "sample-6319c.firebaseapp.com",
    projectId: "sample-6319c",
    storageBucket: "sample-6319c.appspot.com",
    messagingSenderId: "471557553119",
    appId: "1:471557553119:web:38f03fe6c3452ff663226a",
    measurementId: "G-4NR9JJTG0J",
  };
...
// ---------- change marker color
document.getElementById("green-marker").addEventListener("click", () => {
  markerUrl = "http://maps.google.com/mapfiles/ms/icons/green-dot.png";
});

document.getElementById("blue-marker").addEventListener("click", () => {
  markerUrl = "http://maps.google.com/mapfiles/ms/icons/blue-dot.png";
});

document.getElementById("orange-marker").addEventListener("click", () => {
...
function setMapStyle(style) {
  var styleButtons = document
    .getElementById("block-2")
  ...
  switch (style) {
    case "vintage-old-golden-brown":
      ...
      document
        .getElementById("vintage-old-golden-brown")
